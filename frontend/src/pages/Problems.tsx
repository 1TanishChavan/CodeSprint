...
const Problems: React.FC<ProblemsProps> = ({ user }) => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="text-small mb-4">Challenge yourself with coding problems and improve your skills!</p>
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {problems.map((problem) => (
          <div key={problem.id} className="bg-stone-100 dark:bg-gray-800 p-4 rounded shadow">
